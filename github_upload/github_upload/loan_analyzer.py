...
print("The sum of the loans is", (total))

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
print("The average loan is", (total/number_of_loans))
...
discount_rate = 0.2
present_value = future / (1 + (discount_rate)/12) ** remaining_months
...
def present_value ():
    future = new_loan.get("future_value")
    discount_rate = 0.2
